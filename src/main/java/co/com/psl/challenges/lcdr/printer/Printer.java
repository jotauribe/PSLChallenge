...
public class Printer {
    ...
    private void buildPrintingMatrix(int size,
        ...
        this.totalColum = (this.columDig * digits.length())
                + (spaceBetweenDigits * digits.length());

        // crea matriz para almacenar los numero a imprimir
        this.matrizImpr = new String[this.totalFilas][this.totalColum];

        // crea el arreglo de digitos
        digitos = digits.toCharArray();
        ...
        for (char digito : digitos) {
            ...
            pivotX = pivotX + this.columDig + spaceBetweenDigits;
     ...
     */
    private void adicionarLinea(String[][] matriz,
                                int[] punto,
                                String posFija,
                                int size,
                                String caracter) {
